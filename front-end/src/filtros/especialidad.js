...
const URI='http://localhost:8080/prueba/ficha/especialidad/'
const URIM='http://localhost:8080/prueba/medico/especialidad/'

const CompListarEspecialidad=() =>{
    ...
    const getFichas = async() =>{
       ...
       const res = await axios.get(URI+especialidad)
...
export default CompListarEspecialidad;