...
const URI='http://localhost:8080/prueba/ficha/fichaPaciente/'
const URIM='http://localhost:8080/prueba/medico/'

const CompListarPacienteCedula=() =>{
    ...
    const getFichas = async() =>{
       ...
       const res = await axios.get(URI+cedula+"/medico/"+medicoId)
       const res2 = await axios.get(URIM+medicoId)
       setFichas(res.data)
       setMedico(res2.data)
...
export default CompListarPacienteCedula;